...
function renderUi() {
  ...
  if (game.phase === "intro") {
    statusText.textContent = "Launch a fresh arena and test the standalone version of the Ketch-Up concept.";
...
document.getElementById("launch-button").addEventListener("click", startRun);
document.getElementById("overlay-button").addEventListener("click", startRun);
